...
function displayShowsHeader(){
    ...
    let card = document.createElement("article"); card.classList.add("shows__title-card");

    let title1 = document.createElement("p"); title1.classList.add("shows__card-title--header");
    let title2 = document.createElement("p"); title2.classList.add("shows__card-title--header");
    let title3 = document.createElement("p"); title3.classList.add("shows__card-title--header");
    let filler = document.createElement("div"); filler.classList.add("shows__title-filler");
...
function displayShow(show){
    let showsList = document.querySelector(".shows__container");
    let card = document.createElement("article"); card.classList.add("shows__card");

    let dateT = document.createElement("p"); dateT.classList.add("shows__card-title");
    let venueT = document.createElement("p"); venueT.classList.add("shows__card-title");
    let locationT = document.createElement("p"); locationT.classList.add("shows__card-title");
    let date = document.createElement("p"); date.classList.add("shows__card-date");
    let venue = document.createElement("p"); venue.classList.add("shows__card-text");
    let location = document.createElement("p"); location.classList.add("shows__card-text");

    let btn = document.createElement("button"); btn.classList.add("btn"); btn.classList.add("shows__card-btn");
    let divider = document.createElement("div"); divider.classList.add("shows__divider");
